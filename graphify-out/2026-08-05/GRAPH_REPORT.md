...
Cohesion: 0.14
Nodes (19): ArchivePage(), formatDate(), formatDate(), ServiceDetailPage(), Song, addPlaylist(), addService(), addSong() (+11 more)
...
## Knowledge Gaps
- **74 isolated node(s):** `newsreader`, `plexMono`, `metadata`, `Song`, `KEYS` (+69 more)
...
- **What connects `newsreader`, `plexMono`, `metadata` to the rest of the system?**
