...
## Summary
- 183 nodes · 274 edges · 22 communities (10 shown, 12 thin omitted)
...
## Knowledge Gaps
- **74 isolated node(s):** `NAV_ITEMS`, `eslintConfig`, `nextConfig`, `name`, `version` (+69 more)
...
- **What connects `NAV_ITEMS`, `eslintConfig`, `nextConfig` to the rest of the system?**
