...
## Summary
- 210 nodes · 319 edges · 23 communities (12 shown, 11 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `28bbb912`
...
Cohesion: 0.12
Nodes (27): ArchivePage(), formatDate(), formatDate(), ServiceDetailPage(), AddPlaylistModal(), EditPlaylistModal(), ServiceActionsMenu(), displayName() (+19 more)
